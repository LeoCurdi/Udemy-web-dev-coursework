...
app.get('/', (req, res) => {
    //res.send('hi')
    res.render('home') // we dont need to say 'views/home.ejs' since we set the view engine to ejs
})


app.get('/random', (req, res) => {
    const num = Math.floor(Math.random() * 10) + 1
    res.render('random', {rand: num}) // random.ejs
})
...
app.get('/cats', (req, res) => {
    ...
    res.render('cats', {cats}) // we can just say 'cats' instead of 'cats: cats'
})
